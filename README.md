> **NH9 Events Platform** — this repository is an independent deployment of the
> [Hi.Events](https://github.com/HiEventsDev/hi.events) open-source event platform
> (AGPL-3.0) with NH9-specific customizations, built and tested for Render.
> It is **not** a GitHub fork; it is maintained as its own repository.
> Upstream reference commit: `7dec84c` (Hi.Events `develop`). Deploy to Render via
> the included `render.yaml` blueprint. Deployment/testing instructions:
